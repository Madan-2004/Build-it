          ...
          <div className="bg-gray-800 shadow rounded-lg p-6">
            ...
            <section className="user-clubs mb-8">
              ...
              {headedClubs.length === 0 ? (
                <p className="text-gray-400">You are not currently the head of any clubs.</p>
              ) : (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {headedClubs.map((club) => (
                    ...
                    >
                      ...
                      <p className="text-sm text-gray-200">You are the head of this club</p>
                    </Link>
                  ))}
                </div>
              )}
            ...
            <section className="user-clubs">
              <h2 className="text-xl font-semibold mb-4">Clubs You Are a Member Of</h2>
              {memberClubs.length === 0 ? (
                <p className="text-gray-400">You are not currently a member of any clubs.</p>
              ) : (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
