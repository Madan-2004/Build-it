...
const EventInventory = () => {
  ...
  const handleAddItem = () => {
    ...
    fetch(`${API_BASE_URL}/api/events/${eventId}/inventory/items/create/`, {
      method: "POST",
  ...
  const handleEditItem = () => {
    fetch(`${API_BASE_URL}/api/events/inventory/items/update/${editItem.id}/`, {
      method: "PUT",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({
        name: editItem.name,
        ...
        cost: editItem.cost,
        consumable: editItem.consumable
      }),
    })
      .then((response) => {
        if (!response.ok) {
  ...
  const handleDeleteInventory = () => {
    // Fixed URL to match backend pattern
    fetch(`${API_BASE_URL}/api/events/inventory/delete/${inventory.id}/`, { 
      method: "DELETE",
      headers: { "Content-Type": "application/json" }
    })
      .then(response => {
